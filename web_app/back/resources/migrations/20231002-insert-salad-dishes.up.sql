...
BEGIN
    ...
    ('С консервированным шампионьонами и копечной колбасой', 50, salad_category_id),
    ('С консервированным шампионьонами и маринованными огурцами', 55, salad_category_id),
